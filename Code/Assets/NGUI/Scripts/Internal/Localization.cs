...
public static class Localization
{
	...
	static public Dictionary<string, string[]> dictionary
	{
		get
		{
			if (!localizationHasBeenSet) language = PlayerPrefs.GetString("Language", "chinese");
			return mDictionary;
		}
		set
		{
	...
	static public string[] knownLanguages
	{
		get
		{
			if (!localizationHasBeenSet) LoadDictionary(PlayerPrefs.GetString("Language", "chinese"));
			return mLanguages;
		}
	}
	...
	static public string language
	{
		get
		{
			if (string.IsNullOrEmpty(mLanguage))
			{
				...
				mLanguage = PlayerPrefs.GetString("Language", lan != null ? lan[0] : "chinese");
...
//			LoadAndSelect(value);
	...
	static bool LoadDictionary (string value)
	{
		...
		if (loadFunction == null)
		{
			TextAsset asset = Resources.Load<TextAsset>("Language/"+value);
			if (asset != null) bytes = asset.bytes;
		}
