...
[Serializable]
 public class Tab_TAchievement : ITableOperate
{ private const string TAB_FILE_DATA = "t_achievement.txt";
 public enum _ID
 {
 INVLAID_INDEX=-1,
ID_USERGUID,
...
private int m_Idlevel;
 public int Idlevel { get{ return m_Idlevel;}}
...
public bool LoadTable(Hashtable _tab)
 ...
 Tab_TAchievement _values = new Tab_TAchievement();
 _values.m_Copyid =  Convert.ToInt32(valuesList[(int)_ID.ID_COPYID] as string);
_values.m_Idlevel =  Convert.ToInt32(valuesList[(int)_ID.ID_IDLEVEL] as string);
