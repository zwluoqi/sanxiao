...
[Serializable]
 public class Tab_TSpecialChapter : ITableOperate
{ private const string TAB_FILE_DATA = "t_special_chapter.txt";
 public enum _ID
 {
 INVLAID_INDEX=-1,
ID_USERGUID,
...
public bool LoadTable(Hashtable _tab)
 ...
 Tab_TSpecialChapter _values = new Tab_TSpecialChapter();
 _values.m_Copyid =  Convert.ToInt32(valuesList[(int)_ID.ID_COPYID] as string);
_values.m_Isopen =  Convert.ToInt32(valuesList[(int)_ID.ID_ISOPEN] as string);
